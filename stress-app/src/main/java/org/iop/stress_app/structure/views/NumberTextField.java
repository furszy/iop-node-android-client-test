...
public class NumberTextField extends TextField {
    ...
    /**
     * This method gets the integer sets in the textField
     * @return
     */
    public Integer getInteger(){
        return getNumber().intValueExact();
    }

    /**
     * This method sets an integer in the TextField
     * @param inputInteger
     */
    public void setInteger(Integer inputInteger){
        setNumber(new BigDecimal(inputInteger));
    }
}
